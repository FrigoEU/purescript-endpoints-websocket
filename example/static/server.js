...
(function(exports) {/* eslint-env node*/
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      var v1 = Node_WebSocket.webSocketServer({
          port: 8008, 
          server: v
      })();
      return Node_WebSocket.onConnection(v1)(function (ws) {
          return Network_WebSocket.listenTo(Data_Argonaut_Decode_Class.decodeJsonString)(ws)(WSEndpointExample_Model.echochamber)(function (mess) {
              return Network_WebSocket.sendTo(Data_Argonaut_Encode_Class.encodeJsonJString)(ws)(WSEndpointExample_Model.echochamber)(mess);
          });
      })();
  };
  exports["main"] = main;
})(PS["WSEndpointExample.Server"] = PS["WSEndpointExample.Server"] || {});
PS["WSEndpointExample.Server"].main();